      ...
      <div className='flex flex-col justify-center items-center my-[30px]'>
        ...
        <div className='pt-[30px]'>
            ...
            <div className='grid grid-col-2 grid-flow-col gap-5 py-[10px]'>
                <div onClick={()=> setSelected('Male')} className={`bg-white w-[180px] h-[180px] rounded-xl cursor-pointer flex flex-col items-center hover:border-2 border-[#3843FF] ${selected === "Male" && 'border-2'}`}>
                    <p className='font-secondary py-[25px] text-[25px]'>Male</p>
                    <img src={male} alt="" className='h-[50px] w-[50px]' />
                </div>
                <div onClick={()=> setSelected('Female')} className={`bg-white w-[180px] h-[180px] rounded-xl cursor-pointer flex flex-col items-center hover:border-2 border-[#3843FF] ${selected === "Female" && 'border-2'}`}>
