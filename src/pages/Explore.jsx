    ...
    <Navbar />
      ...
      <div className='pt-[30px]'>
        <div className='flex flex-row justify-between'>
          ...
          <div className='grid grid-rows-2 grid-flow-col gap-5 py-[10px]'>
              <div className='w-[250px] h-[150px] rounded-xl bg-[#3843FF] flex flex-col items-center hover:border-2 border-black'>
              ...
              <div className='w-[250px] h-[150px] rounded-xl flex flex-col bg-[#3843FF] items-center hover:border-2 border-black'>
              ...
              <div className='w-[250px] h-[150px] bg-[#3843FF] rounded-xl flex flex-col items-center hover:border-2 border-black'>
